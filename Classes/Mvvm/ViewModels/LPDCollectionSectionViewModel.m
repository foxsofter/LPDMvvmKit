...
- (NSMutableArray<__kindof id<LPDCollectionCellViewModelProtocol>> *)mutableItems {

  return _mutableItems ?: (_mutableItems = [NSMutableArray array]);
}

- (NSArray<__kindof id<LPDCollectionCellViewModelProtocol>> *)items {
  return [_mutableItems copy];
}

- (void)setItems:(NSArray<__kindof id<LPDCollectionCellViewModelProtocol>> *)items {
  if (items) {
